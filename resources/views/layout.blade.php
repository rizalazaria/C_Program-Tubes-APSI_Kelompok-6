...
<body>
    ...
    <div class="container-fluid fixed-atas px-0 wow fadeIn" data-wow-delay="0.1s">
        <nav class="navbar navbar-expand-lg navbar-light py-lg-1 px-lg-5 py-1 wow fadeIn bg-white" data-wow-delay="0.1s"
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav p-4 p-lg-0" style="background-color: #a01626 !important;margin:auto">
                    ...
                    <a href="{{ url('lokerdaftar') }}" class="nav-item nav-link">Loker</a>
                    <a href="{{ url('beasiswadaftar') }}" class="nav-item nav-link">Beasiswa</a>
                    <a href="{{ url('lombadaftar') }}" class="nav-item nav-link">Lomba</a>
                </div>
            </div>
        </nav>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-12 col-md-12">
                    <h4 class="text-white mb-4">Rizana.</h4>
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Jl. xxxx. No. xxx, Kota xxx
                    </p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>085975404345</p>

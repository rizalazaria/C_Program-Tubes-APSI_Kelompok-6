        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <a class="btn btn-primary mb-3" href="{{ url('panel/lokertambah') }}">Tambah</a>
                                    ...
                                    <tbody>
                                        @foreach ($loker as $key => $value)
                                            <tr>
                                                ...
                                                <td><a href="{{ asset('foto/' . $value->foto) }}">
                                                        <img src="{{ asset('foto/' . $value->foto) }}" alt="foto"
                                                            width="100px">
                                                    </a></td>
                                                <td>
                                                    ...
                                                    <a class="btn btn-primary m-1"
                                                        href="{{ url('panel/lokeredit/' . $value->idloker) }}">Edit</a>
                                                    <a class="btn btn-danger bdel m-1"
                                                        href="{{ url('panel/lokerhapus/' . $value->idloker) }}">Hapus</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>

...
<head>
    ...
    <!-- Favicon icon -->
    <link href="" rel="icon"> <!-- Pignose Calender -->
...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo" style="background-color: #a01626 !important">
                <a href="#">
                    <center>
                        <b class="logo-abbr"><img src="{{ url('foto/logo.png') }}" width="30px" alt=""> </b>
                        <span class="logo-compact"><img src="{{ url('foto/logo.png') }}" width="30px"
                                alt=""></span>
                        <span class="brand-title">
                            <img src="{{ url('foto/logo.png') }}" width="30px" alt="">
                        </span>
                    </center>
                </a>
            </div>
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{ url('panel/lokerdaftar') }}" aria-expanded="false">
                            <i class="fas fa-box-archive"></i><span class="nav-text">Loker</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('panel/beasiswadaftar') }}" aria-expanded="false">
                            <i class="fas fa-user-graduate"></i><span class="nav-text">Beasiswa</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('panel/lombadaftar') }}" aria-expanded="false">
                            <i class="fas fa-flag"></i><span class="nav-text">Lomba</span>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    ***********************************-->
    ...
    <script src="https://kit.fontawesome.com/8d0e952a61.js" crossorigin="anonymous"></script>
    <script>

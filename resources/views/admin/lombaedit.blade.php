                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{ url('panel/lombaeditsimpan/' . $lomba->idlomba) }}" method="post"
                                    enctype="multipart/form-data">
                                    <?= csrf_field() ?>
                                    <div class="form-group">
                                        <label>Judul</label>
                                        <input value="<?= $lomba->judul ?>" type="text" class="form-control"
                                            name="judul" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Deskripsi</label>
                                        <input value="<?= $lomba->deskripsi ?>" type="text" class="form-control"
                                            name="deskripsi" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Tanggal</label>
                                        <input value="<?= $lomba->tanggal ?>" type="date" class="form-control"
                                            name="tanggal" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Tanggal Batas Pendaftaran</label>
                                        <input value="<?= $lomba->tanggalbataspendaftaran ?>" type="date"

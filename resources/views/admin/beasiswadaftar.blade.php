        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <a class="btn btn-primary mb-3" href="{{ url('panel/beasiswatambah') }}">Tambah</a>
                                    ...
                                    <tbody>
                                        @foreach ($beasiswa as $key => $value)
                                            <tr>
                                                ...
                                                <td><a href="{{ asset('beasiswa/' . $value->foto) }}">
                                                        <img src="{{ asset('beasiswa/' . $value->foto) }}" alt="foto"
                                                            width="100px">
                                                    </a></td>
                                                <td>
                                                    ...
                                                    <a class="btn btn-primary m-1"
                                                        href="{{ url('panel/beasiswaedit/' . $value->idbeasiswa) }}">Edit</a>
                                                    <a class="btn btn-danger bdel m-1"
                                                        href="{{ url('panel/beasiswahapus/' . $value->idbeasiswa) }}">Hapus</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
